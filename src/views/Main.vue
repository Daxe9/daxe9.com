...
<template>
	<div ref="contentContainer" class="content-line">
		...
		<div v-show="showDetails" class="details">
			<p>I like frontend and backend stuffs, and these are some technologies I experienced with: </p>	
		</div>
		<!-- TODO: comfortable level -->
		<div v-show="showDetails" class="details"></div>
		<div v-show="showDetails" class="details"><p>Frontend: </p></div>
		<div v-show="showDetails" class="details"><p>&nbsp;&nbsp;&nbsp;&nbsp;HTML  Css  Javascript  Nodejs  Typescript  Vuejs, React  Svelte</p></div>
		<div v-show="showDetails" class="details"><p>Backend: </p></div>
		<div v-show="showDetails" class="details"><p>&nbsp;&nbsp;&nbsp;&nbsp;Express  Nestjs</p></div>
		<div v-show="showDetails" class="details"><p>Other tools: </p></div>
		<div v-show="showDetails" class="details"><p>&nbsp;&nbsp;&nbsp;&nbsp;Git, Docker, <span class="underline">Vim</span></p></div>
	</div>
</template>
