...
<template>
	<div ref="contentContainer" class="content-line">
		...
		<div v-show="showDetails" class="details">
			<h1>
				My name is <span class="underline">Davide Xie</span>, currently @Florence, Italy
			</h1>
		</div>
		<div v-show="showDetails" class="details"></div>
		<div v-show="showDetails" class="details">
			<p>
				I like frontend and backend stuffs, and these are some technologies I experienced
				with:
			</p>
		</div>
