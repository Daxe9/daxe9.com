...
<template>
  <div ref="contentContainer" class="content-line">
    ...
    <div v-show="showDetails" class="details">
      <h1>
        My name is <span class="underline">Davide Xie</span>, currently
        @Florence, Italy
      </h1>
    </div>
    ...
    <div v-show="showDetails" class="details">
      <p>
        I like frontend and backend stuffs, and these are some technologies I
        experienced with:
      </p>
    </div>
    ...
    <div v-show="showDetails" class="details">
      <p>
        &nbsp;&nbsp;&nbsp;&nbsp;HTML Css Javascript Nodejs Typescript Vuejs,
        React Svelte
      </p>
    </div>
    ...
    <div v-show="showDetails" class="details">
      <p>
        &nbsp;&nbsp;&nbsp;&nbsp;Git, Docker, <span class="underline">Vim</span>
      </p>
    </div>
  </div>
</template>
